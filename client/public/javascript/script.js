...
let loadPatients = async () => {
    ...
    let getPatientForm = () => {
        ...
        return new Patient(
          ...
          document.getElementById('patient_f_name').value,
          document.getElementById('patient__name').value,
    ...
    let addOrUpdatePatient = () => {
        const newPatient = getPatientForm();
        console.log('%cNew Patient: ', 'color: green', newPatient);
